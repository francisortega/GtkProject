// TableModel.cpp
// Purpose: A model representing a table.
//
...
TableModel::TableModel(Model* parent) : Model(parent)
{
	// Load the texture 
	Texture = Texture::loadDDS("../Source/Models/Table/table.dds");
	...
	bool res = Renderer::LoadOBJ("../Source/Models/Table/table.obj", vertices, uvs, normals);
