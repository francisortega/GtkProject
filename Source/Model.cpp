...
Model::Model(Model* parent) : mName("UNNAMED"), mPosition(0.0f, 0.0f, 0.0f), mScaling(1.0f, 1.0f, 1.0f), mRotationAxis(1.0f, 0.0f, 1.0f), mRotationAngleInDegrees(0.0f), parent(parent)
{
}

Model::~Model()
{
	// Object pointer cleanup
	delete parent;
}
