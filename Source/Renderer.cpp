...
void Renderer::Initialize()
{
	...
	sShaderProgramID.push_back(LoadShaders("../Source/Shaders/PhongFog.vertexshader", "../Source/Shaders/PhongFog.fragmentshader"));
						...
						std::vector<glm::vec3> & out_normals )
{
	...
	while( 1 ){
		...
		if ( strcmp( lineHeader, "v" ) == 0 ){
			...
			temp_uvs.push_back(glm::vec3(uv, 2)); // Set the z to 2 so that we can distinguish between color vectors and uv vectors (2 = UV vector)
